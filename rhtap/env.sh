...
export IMAGE_URL=${IMAGE_URL-quay.io/tnevrlka-rhtap/rhtap-qe-java-quarkus:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/tnevrlka-rhtap/ymwnh54xh-java-quarkus-gitops
